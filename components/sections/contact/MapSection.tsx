...
export default function MapSection() {
  return (
    <section className="bg-page py-[clamp(60px,6.5vw,116px)]">
        ...
        <div className="grid items-center gap-[clamp(24px,3vw,52px)] lg:grid-cols-[1.35fr_0.65fr]">
          ...
          <Reveal delay={90}>
            ...
            <address className="mt-6 not-italic">
              <span className="block text-[clamp(16px,1.1vw,19px)] leading-snug font-semibold text-ink">
                {CONTACT.address.line1}
              </span>
              <span className="block text-[clamp(15px,1vw,17px)] text-ink-2">
